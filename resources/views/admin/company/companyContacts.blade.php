                    ...
                    <tbody>
                        @foreach ($contacts as $contact)
                            <tr>
                                ...
                                <td>
                                  <a href="{{route('admin.companyContacts.edit', ['id'=>$contact->id])}}" class="btn btn-primary">Edit</a>
                                  <a href="{{route('admin.companyContacts.destroy', ['id'=>$contact->id])}}" class="btn btn-danger">Delete</a>
