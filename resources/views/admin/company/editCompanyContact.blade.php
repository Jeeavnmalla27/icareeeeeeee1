                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input id="phone" name="phone_number" type="number" value="{{$contact->phone}}" required class="form-control" />
                            </div>
                          </div>
                        </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="street_name" id="street" value="{{$contact->street_name}}" required class="form-control" />
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="number" name="postal_code" value="{{$contact->postal}}" required id="postal"  class="form-control" />
                        </div>
                      </div>
                    </div>
                  </div>
