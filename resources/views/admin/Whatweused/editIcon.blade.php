        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <form class="forms-sample" enctype="multipart/form-data" action="{{route('admin.icon.update',['id'=>$images->id])}}" method="POST">
                    @csrf
                  <div class="form-group">
                      <label for="name">Title</label>
                      <input type="text" required name="name" id="name" value="{{$images->name}}" class="form-control">
                  </div>
                  <div class="form-group">
                    <label>Icons</label>
